...
ggplot(filtered_income_data_sam2, aes(x = monthly_income_numeric, y = reorder(country, monthly_income_numeric), fill = continent, color = continent)) +
  geom_bar(stat = "identity", alpha = 0.6, size = 1) + # Barra con transparencia y borde
  scale_fill_manual(
    values = c(
      "Africa" = "red4", 
      "Asia" = "olivedrab", 
...
!["Explanation ¿Who does enjoy the most?"](C:/Users/juand/Documents/R%20y%20Python/Data-Visualization-Project/expl.png){width="80%"}
...
!["Explanation Best country for whealtiest"](C:/Users/juand/Documents/R%20y%20Python/Data-Visualization-Project/expl2.png){width="80%"}
